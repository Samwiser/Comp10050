...
void move_player(int num_slots, int num_players, int k)
{
	...
	else if(strcmp(array2[(players_array[k].position) + 1].player_inf,"empty")!=0)
	{
		...
		strcpy(array2[(players_array[k].position)].player_inf, array2[(players_array[k].position) + 1].player_inf);
		strcpy(array2[(players_array[k].position)].type_inf, array2[(players_array[k].position) + 1].type_inf);
		strcpy(array2[(players_array[k].position) + 1].player_inf, "empty");
